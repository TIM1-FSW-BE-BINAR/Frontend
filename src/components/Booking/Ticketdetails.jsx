...
import { Card, Button, Accordion, AccordionBody } from "react-bootstrap";
...
const TicketDetails = ({ isSaved, setIsPayment, dataBooking }) => {
  ...
  const [activeKeyDeparture, setActiveKeyDeparture] = useState("0");
  ...
  return (
    <>
      ...
      >
        ...
        <Accordion
          activeKey={activeKeyDeparture}
          onSelect={(key) =>
            setActiveKeyDeparture(key === activeKeyDeparture ? null : key)
          }
          ...
          <>
            ...
            >
              <Accordion.Item eventKey="0">
                <Accordion.Header className="custom-accordion-header">
                  <div className="d-flex justify-content-between align-items-center">
                    <b className="fw-bold">Return Flight Details</b>
                  </div>
                </Accordion.Header>
                <AccordionBody>
                  <div className="mb-3 d-flex align-items-start justify-content-between">
                  ...
                  <div className="mb-3 d-flex align-items-start justify-content-between">
                    <div>
                      ...
                      <p className="m-0 ">
                        {returnFlight?.data?.arrival?.name}
                      </p>
                    </div>
                    <span
                      style={{
